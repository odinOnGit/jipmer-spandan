...
const EVENT_CATEGORIES = [
  {
    name: "Fine Arts (Exempt)",
    events: [
      { id: 'face_painting', name: "Face Painting", price: 0, exempt: true },
      { id: 'pot_painting', name: "Pot Painting", price: 0, exempt: true },
      { id: 'mehendi', name: "Mehendi", price: 0, exempt: true },
      { id: 'sketching', name: "Sketching", price: 0, exempt: true },
      { id: 'painting', name: "Painting", price: 0, exempt: true }
    ]
  },
  {
    name: "Dance",
    events: [
      { id: 'solo_dance', name: "Solo Dance", price: 125, exempt: false },
      { id: 'duet_dance', name: "Duet Dance", price: 125, exempt: false },
      { id: 'chorea', name: "Choreography", price: 150, exempt: false }
    ]
  },
  {
    name: "Music",
    events: [
      { id: 'tinnitus', name: "Tinnitus", price: 150, exempt: false },
      { id: 'alaap', name: "Alaap", price: 150, exempt: false },
  ...
  },
  {
    ...
    events: [
      ...
      { id: 'dernier_cri', name: "Dernier Cri", price: 150, exempt: false }
    ]
  },
  {
    name: "Sports",
    events: [
      ...
      { id: 'chess_bullet', name: "Chess Bullet", price: 150, exempt: false },
      ...
      { id: 'carroms', name: "Carroms", price: 250, exempt: false },
      ...
      { id: 'badminton', name: "Badminton", price: 250, exempt: false },
      { id: 'table_tennis', name: "Table Tennis", price: 250, exempt: false },
  ...
  },
  {
    name: "Medical (Exempt)",
    events: [
      { id: 'junior_mediquiz', name: "Junior Mediquiz", price: 0, exempt: true },
      { id: 'senior_mediquiz', name: "Senior Mediquiz", price: 0, exempt: true }
    ]
  },
  {
    name: "Photography (Exempt)",
    events: [
      { id: 'snap_saga', name: "Snap Saga", price: 0, exempt: true },
      { id: 'verse', name: "Verse", price: 0, exempt: true },
      { id: 'reel_realm', name: "Reel Realm", price: 0, exempt: true }
    ]
  },
  {
    name: "Informals (Exempt)",
    events: [
      { id: 'treasure_hunt', name: "Treasure Hunt", price: 0, exempt: true },
      { id: 'eatathon', name: "Eatathon", price: 0, exempt: true }
    ]
  }
];
